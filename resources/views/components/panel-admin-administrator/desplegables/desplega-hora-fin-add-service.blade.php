                ...
                <div data-testid="select-dropdown-">
                    <div class="styles_container_pjyTj styles_focusedOrFilled_dNjQS styles_size--md_sPOha styles_theme--default_x92vh styles_slotTheme--blank_iI8Uf styles_slotTheme--default_vYr1T" data-testid="select-input-">
                        <div onclick="abrirModalCategorias('.{{ $contenedorHorasInicio}}')" class="styles_outerWrapper_NumuG" style="min-width: 0px;">
                            ...
                            <input  name="horaInicio" value="0h" placeholder="" id="{{ $idImputInicio }}" type="hidden" autocomplete="off" inputmode="text" class="styles_field_Bhxvq" style="min-width: 0px; text-transform: none;">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div data-testid="select-dropdown-">
                    <div class="styles_container_pjyTj styles_focusedOrFilled_dNjQS styles_size--md_sPOha styles_theme--default_x92vh styles_slotTheme--blank_iI8Uf styles_slotTheme--default_vYr1T" data-testid="select-input-">
                        <div onclick="abrirModalCategorias('.{{ $contenedorHorasFin }}')" class="{{ $contenedorHorasFin }}class styles_outerWrapper_NumuG" style="min-width: 0px;">
                            ...
                            <input  name="horaFin" value="0h" placeholder="" id="{{ $idInputFin }}" type="hidden" autocomplete="off" inputmode="text" class="styles_field_Bhxvq" style="min-width: 0px; text-transform: none;">
                        </div>
                    </div>
                </div>
            </div>
